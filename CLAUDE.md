...
- Saved to: `.claude/thoughts/product/YYYY-MM-DD-<feature-slug>-prd.md`
...
- Saved to: `.claude/thoughts/architecture/YYYY-MM-DD-<feature-slug>-design.md`
- Must start with governance header
...
- Saved to: `.claude/thoughts/plans/YYYY-MM-DD-<feature-slug>.md`
- Must start with governance header
